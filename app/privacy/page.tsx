...
const policySections = [
  {
    ...
    paragraphs: [
      ...
      "מידע אישי שנמסר מרצון: בעת הרשמה לפעילויות האקדמיה, מחנות אימונים, מילוי טפסי יצירת קשר או הצטרפות לקהילת הלקוחות שלנו, אתם עשויים להתבקש למסור פרטים כגון: שם מלא, מספר טלפון, כתובת דואר אלקטרוני, תאריך לידה/גיל השחקן, ופרטי התקשרות של הורים/אפוטרופוס עבור שחקנים קטינים.",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    paragraphs: [
      "כחלק מהפעילות השוטפת של אקדמיית Next Level, אנו עשויים לצלם תמונות וסרטוני וידאו של השחקנים במהלך אימונים, משחקים, מחנות ופעילויות של האקדמיה. מדיה זו עשויה לעלות לאתר, לרשתות החברתיות של האקדמיה כגון אינסטגרם או לשמש לצרכים מקצועיים, כמו עריכת וידאו של שחקנים.",
      "הרשמה לפעילות האקדמיה מהווה הסכמה לשימוש בחומרי צילום אלו לצרכים מקצועיים ושיווקיים של האקדמיה. אם הורה או שחקן מעוניינים להסיר תמונה או סרטון ספציפי, ניתן לפנות אלינו והבקשה תטופל ברגישות ובמהירות.",
    ],
  },
  {
