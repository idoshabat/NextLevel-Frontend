...
const policySections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "במידה שהורה או אפוטרופוס מגלה כי ילדו מסר מידע אישי באתר ללא הסכמתו, הוא מוזמן לפנות אלינו מיידית לכתובת המייל: Office@nextlevelacademy.co.il ואנו נמחוק את המידע בהקדם.",
    ],
  },
  {
