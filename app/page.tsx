...
const tracks = [
  {
    ...
    text: "מעטפת מקצועית ומנטלית לשחקנים ולשחקניות שרוצים לנהל תהליך אמיתי: אימונים אישיים, ניתוח וידאו, מעקב גופני וליווי אונליין.",
    icon: Target,
  },
  {
    title: "CLASSIC וכרטיסיית 10 אימונים",
    text: "אימוני סופ\"ש בקבוצות עבודה איכותיות, עם דגש על יסודות, יכולת אישית וגמישות לשחקנים ולשחקניות שרוצים תגבור נקודתי.",
    icon: Trophy,
  },
  {
    title: "VIDEO ONLINE",
...
const reasons = [
  {
    title: "עברנו את הדרך",
    text: "הצוות שלנו מכיר מבפנים את הדרך משחקן צעיר לשחקן מקצועני, ולכן יודע לכוון כל שחקן ושחקנית דרך עבודה מדויקת, מנטלית ומקצועית.",
    icon: HeartHandshake,
  },
  {
    title: "מעטפת מקצועית ומנטלית",
    text: "לצד האימון על הפרקט, השחקנים והשחקניות מקבלים ליווי בהתמודדות עם לחץ, שפת גוף, קשר מול המועדון והבנת המשחק.",
    icon: ShieldCheck,
  },
  {
    title: "מודל שמתאים לרמות שונות",
    text: "הפעילות מותאמת אישית לכל הרמות, החל מכיתה ה' ועד לבוגרים, דרך מודל אימונים שמאפשר לכל שחקן ושחקנית לקבל את המסגרת הנכונה.",
    icon: Zap,
  },
];
...
const audiences = [
  ...
  "שחקנים ושחקניות מובילים שמחפשים לקחת את המשחק צעד קדימה",
  "שחקנים ושחקניות שרוצים לשפר Basketball IQ וקבלת החלטות",
  "שחקנים ושחקניות שצריכים ליווי מנטלי והתמודדות עם לחץ",
  "שחקנים ושחקניות שצריכים ליווי והכוונה להמשך הקריירה",
  "שחקנים ושחקניות שמחפשים ניתוח וידאו ותמיכה מרחוק",
];
      ...
      <section className="home-band home-band-deep mx-auto w-[min(1180px,calc(100%_-_32px))] py-[clamp(72px,10vw,120px)]">
        <div className="mb-7 flex flex-wrap items-end justify-between gap-4">
          <div className="max-w-[760px]">
            ...
            <h2 className="m-0 text-[clamp(2.2rem,5vw,4.8rem)] leading-none">
              מתוכנית אימונים מקצועית ועד מעטפת מלאה לשחקן/ית ברמות הגבוהות.
            </h2>
          </div>
        ...
        <div className="group mx-auto mt-12 w-[min(980px,100%)] overflow-hidden rounded-lg border border-white/10 bg-[#0b1114] shadow-[0_24px_80px_rgba(0,0,0,0.26),inset_0_1px_0_rgba(255,255,255,0.08)]">
          <div className="relative aspect-[16/8] max-[640px]:aspect-[16/11]">
            <img
              ...
              alt="שחקנים ושחקניות באימון Next Level"
              loading="lazy"
            />
      ...
      <section className="home-band home-band-court mx-auto w-[min(1180px,calc(100%_-_32px))] py-[clamp(72px,10vw,120px)]">
        <div className="mb-7 flex flex-wrap items-end justify-between gap-4">
          <div className="max-w-[760px]">
            ...
            <h2 className="m-0 text-[clamp(2.2rem,5vw,4.8rem)] leading-none">
              מתאימים את המסלול הייחודי והמדויק לכל שחקן ושחקנית.
            </h2>
          </div>
