...
const pillars = [
  {
    ...
    text: "אנחנו לא רק מאמנים שחקנים ושחקניות, אנחנו בונים אנשים, מנהיגים ומקצוענים. התהליך משלב דרישה מקצועית גבוהה יחד עם יחס אישי, חום וערכים.",
    icon: Trophy,
  },
  {
    title: "מהפרקט אל המציאות",
    text: "המאמנים שלנו מכירים את הדרך מבפנים. הניסיון כשחקני עבר והווה מאפשר להם לדבר כדורסל כשפת אם ולכוון כל שחקן ושחקנית בצורה פרקטית.",
    icon: ShieldCheck,
  },
  {
...
const developmentPoints = [
  ...
  "בניית שחקנים ושחקניות חזקים קודם כל כבני אדם",
];
        ...
        <div className="mx-auto w-[min(1080px,calc(100%_-_32px))] rounded-lg border border-white/10 bg-[#030405]/82 px-[clamp(20px,5vw,56px)] py-[clamp(32px,7vw,68px)] shadow-[0_26px_90px_rgba(0,0,0,0.36),inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-sm">
          ...
          <div className="mx-auto mt-10 grid max-w-[880px] gap-5 text-center text-[clamp(1.02rem,1.8vw,1.18rem)] leading-[1.85] text-[#d6dde3]">
            <p className="m-0">
              ...
              שהוקמה כדי להקפיץ שחקנים ושחקניות לרמות
              הגבוהות ביותר בשכבות הגיל שלהם.
            </p>
            <p className="m-0">
              אנחנו מאמינים שההבדל בין שחקן/ית טובים לשחקן/ית מצוינים נמצא בפרטים
            ...
            <p className="m-0 text-[#f7fbff]">
             המטרה: לספק מעטפת מקצועית, מנטאלית וליווי אישי לאורך כל שלבי
              ההתפתחות, ולמצות את הפוטנציאל הטמון בכל שחקן ושחקנית.
            </p>
          </div>
        </div>
      </section>
