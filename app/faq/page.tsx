...
const faqGroups = [
  {
    ...
    questions: [
      ...
      {
        question: "האם \"נקסט\" היא גם סוכנות שחקנים ושחקניות?",
        answer:
          "לא, אנחנו לא סוכנות. \"נקסט\" מעניקה מעטפת מקצועית ומחברת את השחקנים והשחקניות למגוון סוכנים שעובדים איתנו, בהתאם לשיקול דעתנו המקצועי.",
      },
      {
