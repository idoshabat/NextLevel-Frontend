...
const faqGroups = [
  {
    title: "הצטרפות והתאמה",
    questions: [
      {
        question: "לאילו גילאים האקדמיה מתאימה?",
        answer:
          "האקדמיה מיועדת לילדים ונוער בגילאי בית ספר, עם חלוקה לקבוצות לפי גיל, רמה וניסיון. לפני ההצטרפות אנחנו בודקים התאמה כדי לוודא שכל שחקן נמצא במסגרת שתאתגר אותו בצורה נכונה.",
      },
      {
        question: "האם צריך ניסיון קודם בכדורסל?",
        answer:
          "לא בהכרח. יש קבוצות שמתאימות לשחקנים בתחילת הדרך וקבוצות מתקדמות יותר. המטרה היא לפגוש כל שחקן במקום שבו הוא נמצא ולבנות לו התקדמות אמיתית.",
      },
      {
        question: "אפשר להגיע לאימון ניסיון?",
        answer:
          "כן. מומלץ לתאם אימון ניסיון כדי להכיר את הצוות, להבין את רמת הקבוצה ולראות איך השחקן משתלב באימון.",
      },
    ],
  },
  {
    title: "אימונים ותהליך",
    questions: [
      {
        question: "מה לומדים באימונים?",
        answer:
          "האימונים משלבים יסודות כמו כדרור, קליעה, מסירה ועבודת רגליים, לצד קבלת החלטות, משחק קבוצתי, אתלטיקה והרגלי עבודה מקצועיים.",
      },
      {
        question: "כמה פעמים בשבוע מתאמנים?",
        answer:
          "זה תלוי בקבוצה ובמסלול. יש מסלולים שבועיים קבועים, אימונים אישיים ומחנות מרוכזים בחופשות. נמליץ על המסלול המתאים לפי גיל, רמה ומטרה.",
      },
      {
        question: "האם יש יחס אישי בתוך אימון קבוצתי?",
        answer:
          "כן. אנחנו עובדים בקבוצות שמאפשרות לצוות לראות כל שחקן, לתקן בזמן אמת ולתת דגשים אישיים גם בתוך מסגרת קבוצתית.",
      },
    ],
  },
  {
    title: "ציוד, תשלום ופרטים כלליים",
    questions: [
      {
        question: "מה צריך להביא לאימון?",
        answer:
          "נעלי ספורט מתאימות, בקבוק מים, בגדי אימון נוחים והרבה אנרגיה. אם יש ציוד נוסף שצריך למסלול מסוים, נעדכן מראש.",
      },
      {
        question: "איפה מתקיימים האימונים?",
        answer:
          "האימונים מתקיימים במגרשי האקדמיה ובמתחמים שותפים לפי הקבוצה והמסלול. בעת התיאום תקבלו את המיקום המדויק והשעות.",
      },
      {
        question: "איך מתבצע הרישום?",
        answer:
          "משאירים פרטים בעמוד צור קשר או שולחים WhatsApp. נחזור אליכם, נבין את גיל ורמת השחקן, ונתאם את השלב הבא.",
      },
    ],
  },
];
