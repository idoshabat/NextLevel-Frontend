...
const faqGroups = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "לגמרי. בזכות מודל האימונים הייחודי שלנו, התוכנית מותאמת אישית לכל הרמות - החל משחקני ליגה בכירות ה' ועד לבוגרים.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "כן. אנו מציעים שירותי ליווי ותמיכה מרחוק באמצעות ניתוחי משחקי וידאו והכוונה מקצועית לפתרון בעיות בזמן אמת.",
      },
      {
