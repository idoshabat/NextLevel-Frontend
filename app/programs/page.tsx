...
const programs = [
  {
    ...
    icon: CalendarDays,
    description:
      "מתאים לשחקנים ולשחקניות שרוצים לטעום מהשיטה של Next Level או לשלב אימוני תגבור נקודתיים.",
    points: [
  ...
  },
  {
    ...
    icon: Trophy,
    description:
      "מסלולי ליווי לשחקנים ולשחקניות שרוצים מעטפת אישית ומקצועית לאורך העונה, עם התאמה מדויקת לצרכים, למטרות ולשלב ההתפתחות של השחקן/ית.",
    points: [
      "איפיון מדויק של השחקן/ית, המטרות והצרכים המקצועיים",
    ...
    note: "תוכניות הליווי מוגבלות בכמות ואינן מתאימות לכל שחקן ושחקנית. התאמה נעשית לאחר שיחה והיכרות מקצועית.",
  },
  
  {
    ...
    points: [
      ...
      "למידת המשחק בעיניים מקצועיות כדי להפוך שחקן/ית מוכשרים לשחקן/ית חכמים ומנהיגים",
    ],
  },
  {
    title: "אימונים אישיים",
    subtitle: "פיתוח אישי ומדויק לשחקן/ית",
    ages: "אימון אישי",
    schedule: "בתיאום אישי",
    icon: Dumbbell,
    description:
      "אימונים אישיים לשחקנים ולשחקניות שרוצים לעבוד לעומק על יכולות ספציפיות, לתקן הרגלים ולבנות ביטחון דרך יחס אישי מלא.",
    points: [
      "עבודה ממוקדת על קליעה, כדרור, סיומות, מצבי משחק אישיים וקבלת החלטות",
      "תיקון פרטים קטנים שמייצרים שינוי גדול במשחק",
      "התאמת האימון לגיל, לרמה, לתפקיד ולמטרות של השחקן/ית",
        ...
        <div className="mx-auto grid w-[min(1180px,calc(100%_-_32px))] gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          ...
          <div className="border-r border-[rgb(var(--cyan-rgb)/0.45)] pr-6 max-[640px]:border-r-0 max-[640px]:pr-0">
            <h2 className="m-0 text-[clamp(1.65rem,3vw,2.6rem)] leading-tight">
              מתוכנית אימונים מקצועית ועד מעטפת מלאה לשחקן/ית ברמות הגבוהות, כל מסלול בנוי סביב
