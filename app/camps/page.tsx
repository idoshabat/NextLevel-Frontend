...
const camps = [
  {
    ...
    description:
      "מחנה בינלאומי ראשון שנתן לשחקנים ולשחקניות טעימה מאימונים בקצב גבוה, תרבות כדורסל אירופאית וחוויה קבוצתית מחוץ לארץ.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "המחנה הקרוב של האקדמיה יוצא לסלובניה ביוני 2026. המחנה מיועד לשחקנים ולשחקניות שרוצים להתאמן בסביבה מקצועית, לחוות כדורסל בינלאומי ולהתקדם ברמה האישית והקבוצתית.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "מחנה המיועד לשחקנים ולשחקניות צעירים שרוצים להיכנס למסגרת מקצועית, לשפר יסודות ולבנות הרגלי עבודה נכונים כבר בגיל צעיר.",
    highlights: [
    ...
    <div className="overflow-hidden">
      ...
      <section className="mx-auto grid w-[min(1180px,calc(100%_-_32px))] gap-[clamp(72px,9vw,110px)] pb-[clamp(72px,10vw,120px)]">
        <CampCarousel
          ...
          text="מחנות בחו״ל לשחקנים ולשחקניות שרוצים לחוות קצב אימון בינלאומי, עבודה מקצועית וחוויה קבוצתית מחוץ לארץ."
          icon={Plane}
          campList={abroadCamps}
        />
        <CampCarousel
          title="Israel Camps"
          text="מחנות בארץ לשחקנים ולשחקניות שרוצים לעבוד בצורה מרוכזת על יסודות, ביטחון, קצב משחק והרגלי עבודה נכונים."
          icon={Sun}
